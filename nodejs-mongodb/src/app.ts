...
export class App {
  ...
  insertNoise(request: Request, response: Response): void {
    ...
    this.dataAccessService.insertNoise(noise).subscribe((noiseDocument: Noise) => {
  ...
  getNoises(request: Request, response: Response): void {
    ...
    this.dataAccessService.getNoises(noiseFilters).subscribe((noiseDocuments: Noise[]) => {
  ...
  getNoisesDecibelsAverage(request: Request, response: Response): void {
    ...
    this.dataAccessService.getNoisesDecibelsAverage(noiseFilters).subscribe((noiseDocuments: DecibelsAverage[]) => {
      const responseBody: string = `${OutputUtil.toString(noiseDocuments)}`;
      response.send(responseBody);
  ...
  insertPlace(request: Request, response: Response): void {
    ...
    this.dataAccessService.insertPlace(place).subscribe((placeDocument: Place) => {
  ...
  getPlaces(request: Request, response: Response): void {
    ...
    this.dataAccessService.getPlaces(placeFilters).subscribe((placeDocuments: Place[]) => {
